...
void update_stress_response() {
	...
	if ( g_player_stress_level >= 9.0 ) {	g_state[G_PLAYER_STRESS_LEVEL_10];
		...
		setSound(G_SOUND_ID_MOANING, 			G_SOUND_PLAYED);
		setSound(G_SOUND_ID_FAST_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_SCARED_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_HEARTBEAT, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_NORMAL_HEARTBEAT, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_HEARTBEAT, 	G_SOUND_STOPPED);
		...
		setSound(G_SOUND_ID_MOANING, 			G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_BREATHING,	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_SCARED_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_HEARTBEAT, 	G_SOUND_PLAYED);
		...
		setSound(G_SOUND_ID_MOANING, 			G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_SCARED_BREATHING, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_NORMAL_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_HEARTBEAT, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_NORMAL_HEARTBEAT, 	G_SOUND_STOPPED);
		...
		setSound(G_SOUND_ID_NORMAL_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_HEARTBEAT,	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_HEARTBEAT, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_LOW_HEARTBEAT, 	G_SOUND_STOPPED);
		...
		setSound(G_SOUND_ID_FAST_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_SCARED_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_BREATHING, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_LOW_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_FAST_HEARTBEAT, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_HEARTBEAT, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_LOW_HEARTBEAT, 	G_SOUND_STOPPED);
		...
		setSound(G_SOUND_ID_FAST_HEARTBEAT, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_HEARTBEAT, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_HEARTBEAT, 	G_SOUND_PLAYED);
		...
		setSound(G_SOUND_ID_SCARED_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_BREATHING, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_BREATHING, 	G_SOUND_PLAYED);
		setSound(G_SOUND_ID_FAST_HEARTBEAT, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_NORMAL_HEARTBEAT, 	G_SOUND_STOPPED);
		setSound(G_SOUND_ID_LOW_HEARTBEAT, 	G_SOUND_STOPPED);
